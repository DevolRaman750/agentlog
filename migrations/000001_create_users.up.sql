...
-- Create execution_configurations table
...
CREATE TABLE function_definitions (
  ...
  mock_response json NOT NULL DEFAULT ('{}'),
...
-- Create execution_function_configs table
...
-- Insert system user immediately to avoid foreign key issues

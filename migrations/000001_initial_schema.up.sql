-- Initial schema migration - consolidated from existing database structure
-- This migration creates all tables, views, and constraints from the current gogent database
...
-- Create function_definitions table
...
-- Create execution_flow_events table
...
-- NOTE: schema_migrations table is managed by the migration tool and should not be created here
...
-- Insert system user for system functions and configurations
INSERT INTO users (

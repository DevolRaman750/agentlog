-- Revert GitHub Read Code function fixes

-- Remove the setup helper function
DELETE FROM function_definitions 
WHERE name = 'github_setup_info' AND user_id = 'system';

-- Revert github_read_code function to previous state

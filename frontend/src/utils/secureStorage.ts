...
export const API_KEY_VALIDATIONS: Record<string, ApiKeyValidation> = {
  ...
  openRouterApiKey: {
    description: 'OpenRouter API key for Kimi K2 and other models',
    pattern: '^sk-or-[a-zA-Z0-9\\-_]{32,}$',
    errorMessage: 'Please enter a valid OpenRouter API key (starts with sk-or-)',
    required: false,
  },
  openWeatherApiKey: {
...
export const FUNCTION_API_KEY_REQUIREMENTS: Record<string, string[]> = {
  ...
  github_analyze_repository: ['githubApiKey'],
  github_read_code: ['githubApiKey'],
  github_read_issues: ['githubApiKey'],
  github_create_branch: ['githubApiKey'],
  github_create_update_file: ['githubApiKey'],
  github_add_comment: ['githubApiKey'],
  github_update_issue: ['githubApiKey'],
